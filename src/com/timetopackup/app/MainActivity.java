        ...
        if (hey.size() == 0)
        {
        	if (db.getAppDemo() == 1)
        	{
        		...
        		db.addElement(new Element ("Parfum", "TROUSSE DE TOILETTE", "", "0"));
           		...
           		db.addElement(new Element ("Mousse à raser", "VÊTEMENTS", "", "1"));
           		db.addElement(new Element ("Coupe-ongles", "VÊTEMENTS", "", "0"));
           		db.addElement(new Element ("Cotons-tiges", "VÊTEMENTS", "", "0"));
        		db.addElement(new Element ("Déodorant", "VÊTEMENTS", "", "1"));
        		db.addElement(new Element ("Parfum", "VÊTEMENTS", "", "0"));
