...
public class ColorPickerSettings extends View
{
    Paint paint;
    Shader luar;
    ...
    public ColorPickerSettings(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
        setSoftwareLayerType();
    }

    public ColorPickerSettings(Context context, AttributeSet attrs, int defStyle)
    {
